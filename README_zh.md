...
**注：插 USB 状态下禁止进入业务；拔掉 USB 后，长按按键（红黑束线）即可启动业务；若需查看日志可在启动后连接USB查看日志**
...
4. **关键词唤醒后，即可对话， 参考运行日志：**
   ...
   如果是初次唤醒会语音播报验证码xxxx提醒用户到小智后台进行设备绑定，小智后台链接：https://xiaozhi.me/
   注册成功后重新运行脚本唤醒后即可进行正常对话

   ![](./media/20250425132727.png)

6. 参考使用示例视频：`media/example_video.mp4`
